      ...
      <DialogContent className={classes.dialog}>
        ...
        <section className={classes.content}>
          <Typography className={classes.body}>
            If you&apos;re part of a franchise or a larger organization, we may
            be able to set up a group discount that can be passed along to every
            member in your group. To find out more&nbsp;
            <ContactUs />
            .
          </Typography>
          ...
          <DialogActions>
            ...
            <Button
              className={cx(classes.button, isRemove && classes.removeCodeButton)}
            ...
            >
              ...
              ) : <div className={classes.submit}>{submitLabel}</div>}
            </Button>
          </DialogActions>
        </section>
      </DialogContent>
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(GroupCodeDialog));
