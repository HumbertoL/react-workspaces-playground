...
import LoadingGroupCode from 'components/common/loading-group-code';
import SuccessDialog from 'components/common/success-dialog';
import PropTypes from 'prop-types';
import React from 'react';
import { connect } from 'react-redux';
import { bindActionCreators } from 'redux';
import { getIsFreeTrial, shouldSkipPlanAndPayment } from 'selectors/account-selectors';
...
import {
  updateGroupCodeFromUrl as updateGroupCodeFromUrlAction,
...
class SignUp extends React.Component {
  ...
  initializeSignUp = () => {
    const { getPricing, updateGroupCodeFromUrl, updatePlanFromUrl } = this.props;
