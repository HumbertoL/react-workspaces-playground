...
app.use(
	'/opt-out/static',
	express.static('../packages/apps/opt-out/build/static', staticOptions)
);
app.use(
	'/free-trial/static',
	express.static('../packages/apps/free-trial/build/static', staticOptions)
);
app.use(
	'/sign-up/static',
	express.static('../packages/apps/sign-up/build/static', staticOptions)
);
...
app.get('/opt-out/asset-manifest.json', function(req, res) {
	res.sendFile(
		path.join(
			__dirname,
			'../packages/apps/opt-out/build/asset-manifest.json'
		)
	);
});
...
app.get('/free-trial/asset-manifest.json', function(req, res) {
	res.sendFile(
		path.join(
			__dirname,
			'../packages/apps/free-trial/build/asset-manifest.json'
		)
	);
});
...
app.get('/sign-up/asset-manifest.json', function(req, res) {
	res.sendFile(
		path.join(
			__dirname,
			'../packages/apps/sign-up/build/asset-manifest.json'
		)
	);
});
